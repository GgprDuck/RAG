...
exports.ragConfig = (0, config_1.registerAs)(exports.RAG_CONFIG, () => {
    ...
    return {
        ...
        textRagVectorSize: TEXT_RAG_VECTOR_SIZE
            ...
            : 768,
        textRagHnswConfig: parseHnswConfig(TEXT_RAG_HNSW_M, TEXT_RAG_HNSW_EF_CONSTRUCT, TEXT_RAG_HNSW_EF_SEARCH),
        ...
        imageRagMinScoreThreshold: IMAGE_RAG_MIN_SCORE_THRESHOLD
            ...
            : 0.55,
        imageRagHnswConfig: parseHnswConfig(IMAGE_RAG_HNSW_M, IMAGE_RAG_HNSW_EF_CONSTRUCT, IMAGE_RAG_HNSW_EF_SEARCH),
    };
});
