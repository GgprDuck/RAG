...
export declare class ImageRagService implements ImageRagPort {
    ...
    constructor(ragSettings: IRagSettingsPort, embeddingPort: IEmbeddingPort, chatLlm: IChatLlmPort, storage: IStoragePort, imageRepository: IImageDocumentRepository, logger: LoggerPort);
